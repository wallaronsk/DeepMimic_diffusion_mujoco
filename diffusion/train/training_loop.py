...
from diffusion.diffusion import logger
from diffusion.utils import dist_util
from diffusion.diffusion.fp16_util import MixedPrecisionTrainer
from diffusion.diffusion.resample import LossAwareSampler, UniformSampler
from tqdm import tqdm
from diffusion.diffusion.resample import create_named_schedule_sampler
# from diffusion.eval.eval_diffmimic import eval_humanml, eval_humanact12_uestc
from diffusion.data_loaders.get_data import get_dataset_loader
...
class TrainLoop:
    ...
    def forward_backward(self, batch):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            compute_losses = functools.partial(
                ...
                self.ddp_model,
                micro,  # x_start [bs, ch, image_size, image_size]
    ...
    # def forward_backward_mdm(self, batch, cond):
        # self.mp_trainer.zero_grad()
        # for i in range(0, batch.shape[0], self.microbatch):
        #     # Eliminates the microbatch feature
        #     assert i == 0
